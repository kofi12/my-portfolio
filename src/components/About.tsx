  ...
  return (
    <section className="flex bg-slate-600 w-[100%] h-[431px]">
      ...
      <p className="text-[#dee7e7] text-[32px] text-right mx-5 mt-5">
        ...
        only look great but perform seamlessly. Whether you're a small business,
        an entrepreneur, or an individual, I'm here to bring your vision to life
        with a focus on detail, creativity, and functionality.
      </p>
    </section>
  );
}
